                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-gray-950 border border-gray-800 text-white px-4 py-3 pr-12 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all placeholder-gray-700"
                                    placeholder="••••••••"
                                    required
                                />
                                <button
