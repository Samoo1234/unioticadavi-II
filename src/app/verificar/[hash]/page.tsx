    ...
    return (
        <html lang="pt-BR">
            <head>
                ...
                <meta name="theme-color" content={isValid ? "#16a34a" : "#dc2626"} />
                <link rel="manifest" href="/manifest.json" />
                <title>Verificação de Receita</title>
            </head>
            <body style={{ margin: 0, fontFamily: "'Segoe UI', system-ui, sans-serif", background: "#0a0a0a", color: "#fff", minHeight: "100vh" }}>
